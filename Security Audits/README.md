...
- [Activity: Analysis of Network Hardening](Activity_Analysis_of_Network_Hardening.md)
...
- [Activity: Analyze Network Attacks](Activity_Analyze_Network_Attacks_Report.md)
...
- [Activity: Apply OS Hardening Techniques](Activity_Apply_OS_Hardening_Techniques.md)
...
- [Connect and Protect: Comprehensive Network Security Report](Connect_and_Protect_Module_Report.md)
  - What it is: A broader learning-style report covering network fundamentals, protocols, common attacks, and defensive controls (modules 1–3).
...
- [First security audit Lab (Barton Toys)](First%20security%20audit%20Lab.md)
...
- [Reinforce system hardening and vulnerability defense Dialogue](Reinforce%20system%20hardening%20and%20vulnerability%20defense%20Dialogue)
...
- [Cybersecurity Incident Report: Network Traffic Analysis](cybersecurity-incident-report-network-traffic-analysis.md)
